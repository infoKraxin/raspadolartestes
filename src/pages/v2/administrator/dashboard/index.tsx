...
export default function AdminDashboardPage() {
  ...
  const getMetricsBarData = () => {
    ...
    return [
      {
        name: "Depósitos",
        aprovados: Number.parseFloat(stats.deposits.approved.amount),
        pendentes: Number.parseFloat(stats.deposits.pending.amount),
        rejeitados: Number.parseFloat(stats.deposits.rejected.amount),
      },
      {
        name: "Saques",
        aprovados: Number.parseFloat(stats.withdrawals.approved.amount),
        pendentes: Number.parseFloat(stats.withdrawals.pending.amount),
        rejeitados: Number.parseFloat(stats.withdrawals.rejected.amount),
      },
    ]
  }
  ...
  const getVolumeAreaData = () => {
    ...
    return [
      {
        name: "Depósitos",
        total: Number.parseFloat(stats.deposits.total.amount),
        aprovados: Number.parseFloat(stats.deposits.approved.amount),
        pendentes: Number.parseFloat(stats.deposits.pending.amount),
      },
      {
        name: "Saques",
        total: Number.parseFloat(stats.withdrawals.total.amount),
        aprovados: Number.parseFloat(stats.withdrawals.approved.amount),
        pendentes: Number.parseFloat(stats.withdrawals.pending.amount),
      },
      {
        name: "Jogos",
        total: Number.parseFloat(stats.games.totalBet),
        distribuido: Number.parseFloat(stats.games.totalDistributed),
            ...
            {!stats && (
              <div>
                ...
                <p className="text-neutral-400 max-w-md">
                  As páginas de administração foram desativadas, pois dependem de uma API para gerenciar dados. Este
                  projeto está configurado para rodar sem API.
                </p>
