        ...
        <SidebarProvider>
          ...
          <SidebarInset>
            <header className="flex h-16 shrink-0 items-center gap-2 border-b border-neutral-700 bg-neutral-800 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator className="hidden md:block text-neutral-600" />
                  <BreadcrumbItem>
                    <BreadcrumbPage className="text-white font-medium">Credenciais</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </header>
            ...
            <div className="flex flex-1 flex-col gap-6 p-6 bg-neutral-900 items-center justify-center text-center">
              <KeyRound className="w-16 h-16 text-neutral-500 mb-4" />
              <h1 className="text-2xl font-bold text-white mb-2">Funcionalidade de Credenciais Desativada</h1>
              <p className="text-neutral-400 max-w-md">
                Esta página de gerenciamento de credenciais foi desativada, pois depende de uma API para configurar
                chaves e tokens.
              </p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-400 text-sm">Gerencie as credenciais de integração com a Pluggou</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <Button onClick={handleEdit} className="bg-yellow-600 hover:bg-yellow-700 text-white">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                      credentials?.is_configured ? "bg-green-500/20" : "bg-red-500/20"
                    }`}
                  >
                    <Shield className={`w-6 h-6 ${credentials?.is_configured ? "text-green-400" : "text-red-400"}`} />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white">Status da Configuração</h3>
      ...
      <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <DialogContent className="max-w-2xl bg-neutral-800 border-neutral-700 text-white">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="organization_id" className="text-neutral-300">
                Organization ID
              </Label>
              <Input
                id="organization_id"
            ...
            <div className="space-y-2">
              <Label htmlFor="base_url" className="text-neutral-300">
                Base URL
              </Label>
              <Input
                id="base_url"
