        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-2xl font-bold text-white">
              R$ {Number.parseFloat(paymentData.deposit.amount).toFixed(2).replace(".", ",")}
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mb-6 p-3 bg-amber-500/10 rounded-lg border border-amber-500/20">
            ...
            <span className="text-amber-400 text-sm font-medium">Expira em: {formatTime(timeLeft)}</span>
          </div>

          {/* PIX Code */}
          <div className="mb-6">
            <Label className="text-white font-medium mb-3 block">Código PIX (Copia e Cola)</Label>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-neutral-300 text-sm">Abra o app do seu banco e escolha a opção PIX</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">
                2
              </div>
              <p className="text-neutral-300 text-sm">Selecione "Pix Copia e Cola" e cole o código acima</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">
                3
              </div>
              <p className="text-neutral-300 text-sm">Confirme o pagamento e aguarde a aprovação</p>
            </div>
          </div>
...
const DepositPage: React.FC = () => {
  ...
  const { user } = useAuth() // Usar o user do contexto mockado
  ...
  const getCurrentAmount = () => {
    return Number.parseFloat(customAmount.replace(",", ".")) || 0
  }
  ...
  return (
    <div className={`${poppins.className} min-h-screen bg-neutral-900`}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <Button
            ...
            variant="outline"
            className="flex items-center gap-2 text-neutral-400 hover:text-white transition-colors mb-4 bg-transparent"
          >
          ...
          <p className="text-neutral-400">Adicione saldo à sua conta de forma rápida e segura</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
              ...
              {/* Quick Amounts */}
              <div className="mb-6">
                <Label className="text-white font-medium mb-3 block">Valores Rápidos</Label>
              ...
              <div className="space-y-2">
                ...
                <p className="text-neutral-500 text-sm">Valor mínimo: R$ 1,00</p>
              </div>
            </div>
            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
              ...
              <div className="p-4 bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 rounded-lg border border-yellow-500/20">
                ...
                <p className="text-neutral-300 text-sm">Pagamento processado automaticamente em até 2 minutos</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6 sticky top-8">
              ...
              <div className="mt-6 pt-4 border-t border-neutral-700">
                ...
                <p className="text-neutral-400 text-xs mb-3">Precisa de ajuda? Nossa equipe está sempre disponível.</p>
                <Button
                  variant="outline"
                  size="sm"
      ...
      {/* Payment Modal */}
      {paymentData && (
        <PaymentModal isOpen={showPaymentModal} onClose={() => setShowPaymentModal(false)} paymentData={paymentData} />
      )}
    </div>
  )
}
